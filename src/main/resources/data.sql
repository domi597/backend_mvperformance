...
-- 4. OFFERS
-- Frühjahrs-Check: Services 1+2+3 → 30+45+90 = 165 min, Paketpreis 149.99
-- Klimaservice:    Service 5       → 60 min,             Paketpreis 59.99
INSERT INTO offers (title, description, price, duration, active, created_at)
VALUES ('Frühjahrs-Check', 'Ölwechsel + Bremsen + Reifencheck', 149.99, 165, true, CURRENT_TIMESTAMP);

INSERT INTO offers (title, description, price, duration, active, created_at)
VALUES ('Klimaservice', 'Kältemittel + Desinfektion + Check', 59.99, 60, true, CURRENT_TIMESTAMP);
...
INSERT INTO appointments (user_id, vehicle_id, service_id, customer_name, service_type, vehicle, preferred_date, status, price, created_at)
VALUES (2, 1, 2, 'Thomas Kauer',    'Reifenwechsel',  'VW Golf 2019',  CURRENT_TIMESTAMP + INTERVAL '4 days',  'NEU',           39.99,  CURRENT_TIMESTAMP - INTERVAL '8 days');

INSERT INTO appointments (user_id, vehicle_id, service_id, customer_name, service_type, vehicle, preferred_date, status, price, created_at)
VALUES (3, 2, 1, 'Maria Schreiner', 'Ölwechsel',      'BMW X3 2021',   CURRENT_TIMESTAMP + INTERVAL '5 days',  'ABGELEHNT',     49.99,  CURRENT_TIMESTAMP - INTERVAL '8 days');

INSERT INTO appointments (user_id, vehicle_id, service_id, customer_name, service_type, vehicle, preferred_date, status, price, created_at)
VALUES (4, 3, 3, 'Stefan Bauer',    'Bremsenservice', 'Audi A4 2017',  CURRENT_TIMESTAMP + INTERVAL '6 days',  'NEU',           89.99,  CURRENT_TIMESTAMP - INTERVAL '8 days');
...
INSERT INTO appointments (user_id, vehicle_id, service_id, customer_name, service_type, vehicle, preferred_date, status, price, created_at)
VALUES (3, 2, 3, 'Maria Schreiner', 'Bremsenservice', 'BMW X3 2021',   CURRENT_TIMESTAMP + INTERVAL '8 days',  'BESTÄTIGT',     89.99,  CURRENT_TIMESTAMP - INTERVAL '8 days');

INSERT INTO appointments (user_id, vehicle_id, service_id, customer_name, service_type, vehicle, preferred_date, status, price, created_at)
VALUES (4, 3, 1, 'Stefan Bauer',    'Ölwechsel',      'Audi A4 2017',  CURRENT_TIMESTAMP + INTERVAL '9 days',  'ABGESCHLOSSEN', 49.99,  CURRENT_TIMESTAMP - INTERVAL '8 days');

INSERT INTO appointments (user_id, vehicle_id, service_id, customer_name, service_type, vehicle, preferred_date, status, price, created_at)
VALUES (2, 1, 3, 'Thomas Kauer',    'Bremsenservice', 'VW Golf 2019',  CURRENT_TIMESTAMP + INTERVAL '10 days', 'NEU',           89.99,  CURRENT_TIMESTAMP - INTERVAL '8 days');

INSERT INTO appointments (user_id, vehicle_id, service_id, customer_name, service_type, vehicle, preferred_date, status, price, created_at)
VALUES (3, 2, 2, 'Maria Schreiner', 'Reifenwechsel',  'BMW X3 2021',   CURRENT_TIMESTAMP + INTERVAL '11 days', 'NEU',           39.99,  CURRENT_TIMESTAMP - INTERVAL '8 days');
...
INSERT INTO appointments (user_id, vehicle_id, service_id, customer_name, service_type, vehicle, preferred_date, status, price, created_at)
VALUES (4, 3, 2, 'Stefan Bauer',    'Reifenwechsel',  'Audi A4 2017',  CURRENT_TIMESTAMP + INTERVAL '15 days', 'NEU',           39.99,  CURRENT_TIMESTAMP - INTERVAL '8 days');

INSERT INTO appointments (user_id, vehicle_id, service_id, customer_name, service_type, vehicle, preferred_date, status, price, created_at)
VALUES (2, 1, 1, 'Thomas Kauer',    'Ölwechsel',      'VW Golf 2019',  CURRENT_TIMESTAMP + INTERVAL '16 days', 'ABGESCHLOSSEN', 49.99,  CURRENT_TIMESTAMP - INTERVAL '8 days');
...
INSERT INTO appointments (user_id, vehicle_id, service_id, customer_name, service_type, vehicle, preferred_date, status, price, created_at)
VALUES (4, 3, 3, 'Stefan Bauer',    'Bremsenservice', 'Audi A4 2017',  CURRENT_TIMESTAMP + INTERVAL '18 days', 'NEU',           89.99,  CURRENT_TIMESTAMP - INTERVAL '8 days');

INSERT INTO appointments (user_id, vehicle_id, service_id, customer_name, service_type, vehicle, preferred_date, status, price, created_at)
VALUES (2, 1, 2, 'Thomas Kauer',    'Reifenwechsel',  'VW Golf 2019',  CURRENT_TIMESTAMP + INTERVAL '19 days', 'BESTÄTIGT',     39.99,  CURRENT_TIMESTAMP - INTERVAL '8 days');

INSERT INTO appointments (user_id, vehicle_id, service_id, customer_name, service_type, vehicle, preferred_date, status, price, created_at)
VALUES (3, 2, 3, 'Maria Schreiner', 'Bremsenservice', 'BMW X3 2021',   CURRENT_TIMESTAMP + INTERVAL '20 days', 'NEU',           89.99,  CURRENT_TIMESTAMP - INTERVAL '8 days');
...
INSERT INTO appointments (user_id, vehicle_id, service_id, customer_name, service_type, vehicle, preferred_date, status, price, created_at)
VALUES (3, 2, 1, 'Maria Schreiner', 'Ölwechsel',      'BMW X3 2021',   CURRENT_TIMESTAMP + INTERVAL '23 days', 'BESTÄTIGT',     49.99,  CURRENT_TIMESTAMP - INTERVAL '8 days');

INSERT INTO appointments (user_id, vehicle_id, service_id, customer_name, service_type, vehicle, preferred_date, status, price, created_at)
VALUES (4, 3, 2, 'Stefan Bauer',    'Reifenwechsel',  'Audi A4 2017',  CURRENT_TIMESTAMP + INTERVAL '24 days', 'NEU',           39.99,  CURRENT_TIMESTAMP - INTERVAL '8 days');

INSERT INTO appointments (user_id, vehicle_id, service_id, customer_name, service_type, vehicle, preferred_date, status, price, created_at)
VALUES (2, 1, 3, 'Thomas Kauer',    'Bremsenservice', 'VW Golf 2019',  CURRENT_TIMESTAMP + INTERVAL '25 days', 'AUSSTEHEND',    89.99,  CURRENT_TIMESTAMP - INTERVAL '8 days');
...
INSERT INTO appointments (user_id, vehicle_id, service_id, customer_name, service_type, vehicle, preferred_date, status, price, created_at)
VALUES (3, 2, 2, 'Maria Schreiner', 'Reifenwechsel',  'BMW X3 2021',   CURRENT_TIMESTAMP + INTERVAL '29 days', 'AUSSTEHEND',    39.99,  CURRENT_TIMESTAMP - INTERVAL '8 days');

INSERT INTO appointments (user_id, vehicle_id, service_id, customer_name, service_type, vehicle, preferred_date, status, price, created_at)
VALUES (4, 3, 1, 'Stefan Bauer',    'Ölwechsel',      'Audi A4 2017',  CURRENT_TIMESTAMP + INTERVAL '30 days', 'NEU',           49.99,  CURRENT_TIMESTAMP - INTERVAL '8 days');
